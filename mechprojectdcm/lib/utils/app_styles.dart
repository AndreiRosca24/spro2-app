...
class Styles {
  static Color paywallColor = const Color.fromARGB(255, 250, 67, 67);
  static Color purple = const Color.fromARGB(255, 75, 25, 255);
  static Color purpleFaded = const Color.fromARGB(115, 75, 25, 255);
